...
pub const CORE_ERROR_CODES: &[&str] = &[
    ...
    "component_store_catalog_invalid",
    "component_store_catalog_incomplete",
    "component_store_open_failed",
    "component_store_list_installations_failed",
    "component_store_error",
    "component_store_unknown_component",
    "component_store_invalid_whisper_selection",
    "component_store_invalid_model_reference",
    "component_store_model_reference_required",
    "component_store_lease_released",
    "component_lease_lost",
    "stale_store_root",
    "foreign_or_incompatible_operation",
    "ambiguous_source",
    "operation_owned",
    "legacy_runtime_selection_removed",
    "legacy_model_download_removed",
